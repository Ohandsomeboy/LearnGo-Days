...
const (
	...
	RouteGuide_ListFeature_FullMethodName = "/route.RouteGuide/ListFeature"
...
func (c *routeGuideClient) ListFeature(ctx context.Context, in *Rectangle, opts ...grpc.CallOption) (RouteGuide_ListFeatureClient, error) {
	stream, err := c.cc.NewStream(ctx, &RouteGuide_ServiceDesc.Streams[0], RouteGuide_ListFeature_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
